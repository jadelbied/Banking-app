    ...
    CommandLineRunner initDataBase(ICustomerService customerService,
        ...
        return args -> {
            customerService.createCustomer(AddCustomerRequest.builder().username("user1")
                    ...
                    .lastname("LAST_NAME1")
                    .dateanniv(new Date()) // Add dateAnniv field
                    .email("user1@example.com") // Add email field
                    .codepostal("12345") // Add codepostal field
                    .build());
            ...
            customerService.createCustomer(AddCustomerRequest.builder().username("user2")
                    .identityRef("A200")
                    .firstname("FIRST_NAME2")
                    .lastname("LAST_NAME2")
                    .dateanniv(new Date()) // Add dateAnniv field
                    .email("user2@example.com") // Add email field
                    .codepostal("67890") // Add codepostal field
                    .build());
            ...
            customerService.createCustomer(AddCustomerRequest.builder().
                    ...
                    lastname("LAST_NAME9").dateanniv(new Date()) // Add dateAnniv field
                    .email("user5@example.com") // Add email field
                    .codepostal("67890") // Add codepostal field
                    .build());
            ...
            customerService.createCustomer(AddCustomerRequest.builder().
                    ...
                    lastname("LAST_NAME8").dateanniv(new Date()) // Add dateAnniv field
                    .email("user7@example.com") // Add email field
                    .codepostal("67890") // Add codepostal field
                    .build());
